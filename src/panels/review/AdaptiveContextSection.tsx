...
export function AdaptiveContextSection() {
  const t = useTheme();
  ...
  return (
    ...
    >
      ...
      <div className="flex items-center gap-3">
        <div className="w-8 h-8 rounded-lg flex items-center justify-center" style={{ background: '#FE500015' }}>
          <RefreshCw size={16} style={{ color: '#FE5000' }} />
        </div>
        <div className="flex-1">
          <div className="text-sm font-semibold" style={{ color: t.textPrimary }}>Smart Retrieval</div>
