  ...
  return (
    <div className="rounded-md nodrag nowheel" style={{ background: enabled ? t.surfaceElevated : 'transparent', transition: 'background 0.12s ease' }}>
      ...
      >
        ...
        <span className="text-[8px] px-1.5 py-0.5 rounded-full shrink-0 uppercase" style={{ background: dirColor, color: '#fff', fontFamily: "'Space Mono', monospace", fontWeight: 600, lineHeight: 1 }}>
          {dirLabel}
        </span>
